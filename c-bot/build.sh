...
emcc main.c -o bot.wasm -s WASM=1 -s INITIAL_HEAP=64kb -s STACK_SIZE=64kb -s MAXIMUM_MEMORY=512kb -s ALLOW_MEMORY_GROWTH=1  -Wl,--stack-first -Wl,--no-demangle -Wl,--no-entry -Wl,--import-memory
